...
Scrapes career pages of ~525 companies for backend SWE internships and new grad roles, targeting the **~May 2027 graduating class**. Filters by US-only locations, excludes PhD-required, senior, and frontend roles, and categorizes into:
- Summer 2027 Intern
...
- **Company config** (`companies.yaml`): ~525 entries. Each has `name`, `ats`, and either `board_id` or `url`.
